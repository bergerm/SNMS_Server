...
namespace SNMS_Server.Connection
{
    enum ProtocolMessageType
    {
        ...
        PROTOCOL_MESSAGE_GET_PLUGINS_WITH_BLOBS,
        ...
        PROTOCOL_MESSAGE_GET_LAST_100_LOGS,
        PROTOCOL_MESSAGE_LAST_100_LOGS_ANSWER,

        PROTOCOL_MESSAGE_SAVE_CONFIGURATION_STATUS_MESSAGE,
        PROTOCOL_MESSAGE_GET_CONFIGURATIONS_STATUS,
        PROTOCOL_MESSAGE_CONFIGURATIONS_STATUS_LIST
    }
