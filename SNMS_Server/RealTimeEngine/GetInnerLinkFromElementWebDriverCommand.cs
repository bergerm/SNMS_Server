...
{
    class GetInnerLinkFromElementWebDriverCommand : WebDriverCommand
    {
        string m_sSourceElementName;
        string m_sDestinationVariableName;

        public GetInnerLinkFromElementWebDriverCommand(string sSourceElementName,
                                                        string sDestVariableName ) : base("GetInnerLinkFromElement")
        {
        ...
        override protected bool CommandLogic()
        {
            ...
            try
            {
                sInnerText = element.GetIWebElement().GetAttribute("href");
            }
            catch(Exception e)
            {
                return false;
        ...
        {
            return new GetInnerLinkFromElementWebDriverCommand(m_sSourceElementName, m_sDestinationVariableName);
        }
    }
}
